...
Each endpoint gets its own hostname under `*.edge.engress.io` with a valid TLS certificate. Use production tunnels (not self-signed) when connecting strict clients like Cursor.
